...
//////////////////////////////////////////////common actions for all controllers////////////////////////////////////////////////////////////////////////////////	
	...
	public function unstrip_array($array){
...

	{
        ...
        $MainMenu = $this->_arrayDb->loadArrayv2("EP_BO_MainMenu", $this->_lang);
...

            {
				...
				$this->_view->menuId = $menuId;

				$this->_view->submenuId = $submenuId;

                /*$myarr = array('ML1'=>0,'ML2'=>1,'ML3'=>2,'ML4'=>3,'ML5'=>4);
				...
				$SubMenu = $this->_arrayDb->loadArrayv2($menuId, $this->_lang);

				$this->_view->SubMenusLeftPanel= $SubMenu;
         ...
         //////////////////service client block/////////////////////////////////////////
                    ...
                    $inbox_messages= $ticket->getUserInbox('contributor',$contrib_identifier);
...

                    {
...

                        {
...

                            {
                                ...
                                $inbox_messages[$i]['text_message']=stripslashes(substr($message['content'],0,254))."[...]";
                                ...
                                $inbox_messages[$i]['text_message']=stripslashes($message['content']);
                       ...
                       // $this->_view->Inbox_Messages=print_r($inbox_messages,true);
                        ...
                        $this->_view->Inbox_Messages='No Messages Found.';
                ////////////////////////////////////////////////////

		        //////////////////payments block/////////////////////////////////////////

                    $payment=new Ep_Transaction_Payment();

                    $contrib_identifier= $this->EP_Contrib_reg->clientidentifier;

                    $payments= $payment->getInstantPayment();

                   $this->_view->Payments=$payments;
                  ////////////////////////////////////////////////////
	...
	{
		$conf_obj=new Ep_Ao_Configuration();
