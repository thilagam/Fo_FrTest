			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a class="navbar-btn btn btn-primary btn-sm" href="/client/quotes-1">Nos tarifs</a></li>
	 ...
	 <div id="funnel">
    	...
    	<div class="container">
    		...
    		<ul class="nav nav-pills nav-justified">
				...
				<li <?php if ($this->_tpl_vars['pagemenu'] == 1): ?>class="active animated bounceIn"<?php endif; ?>><a href="#"><img src="/FO/images/imageB3/sprites/quote-step-1.png" width="50" height="50">1. Votre demande</a></li>

				<li <?php if ($this->_tpl_vars['pagemenu'] == 2): ?>class="active animated bounceIn"<?php endif; ?>><a href="#2"><img src="/FO/images/imageB3/sprites/quote-step-2.png" width="50" height="50">2. Qui êtes-vous ?</a></li>

				<li <?php if ($this->_tpl_vars['pagemenu'] == 3): ?>class="active animated bounceIn"<?php endif; ?>><a href="#3"><img src="/FO/images/imageB3/sprites/quote-step-3.png" width="50" height="50">3. Validation</a></li>
