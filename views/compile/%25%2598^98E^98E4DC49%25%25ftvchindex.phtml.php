<?php /* Smarty version 2.6.19, created on 2015-09-04 15:09:53
         compiled from Client/ftvchindex.phtml */ ?>
<?php echo '
...
<section id="quote-listing-table">
	<div class="mod">  <a  data-target="#newrequest" data-refresh="true"  data-toggle="modal"  role="button" class="btn btn-success pull-left"  href="/ftvchaine/newrequest">Ajouter Une Demande</a>
		<table id="scltable">
			<thead>
				<tr>
