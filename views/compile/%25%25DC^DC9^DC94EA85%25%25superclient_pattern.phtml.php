<?php /* Smarty version 2.6.19, created on 2014-07-07 12:16:45
         compiled from common/pattern/superclient_pattern.phtml */ ?>
<!DOCTYPE html>
<html lang="fr">
	<head>
...
?>
			<script language="JavaScript" type="text/javascript" src="http://mmm-new.edit-place.com/FO/script/<?php echo $this->_tpl_vars['javascript']; ?>
"></script>
...
?>
			<link href="http://mmm-new.edit-place.com/FO/css/<?php echo $this->_tpl_vars['css']; ?>
