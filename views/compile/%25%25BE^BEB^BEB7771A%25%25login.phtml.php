...
'; ?>
	...
	<div class="modal-body">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="login_name"><b>Votre Email</b></label>
		...
		<div class="form-group">
			<label class="col-sm-4 control-label" for="login_password"><b>Votre mot de passe</b></label>
			<div class="col-xs-12 col-md-6">
				<input type="password" name="login_password" id="login_password" placeholder="Mot de passe" class="form-control" />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-md-6">
				<a data-target="#lost-password" data-toggle="modal" class="killcurrentmodal">Mot de passe oubli&eacute; ?</a>
			</div>
		</div>
