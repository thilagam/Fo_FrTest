...
<div id="switch-country" class="animated fadeInDown">
	<div class="container">
		<div class="alert fade in">
			...
			Nous avons détecté que vous vous connectez depuis un lieu situé en dehors de France.
			</h4>
		...
		<div class="container">
			...
			<div class="center-block">
				...
				<div class="cta-collections">
					...
					<a href="/client/quotes-1" class="btn btn-primary btn-lg" role="button">Découvrez nos tarifs</a>
